...
$loader->register();
$loader = new ClassLoader('Doctrine\\ODM\\MongoDB\\Tests', __DIR__ . '/../lib/Doctrine/Search/sandbox/vendor/doctrine-mongodb-odm/tests');
$loader->register();
$loader = new ClassLoader('Doctrine\\ODM\\MongoDB', __DIR__ . '/../lib/Doctrine/Search/sandbox/vendor/doctrine-mongodb-odm/lib');
$loader->register();
